...
class MusicManagerImpl @Inject constructor(
    ...
    private val getSongFileInfoUseCase: GetSongFileInfoUseCase,
    ...
    override suspend fun getSongFile(songId: String): Outcome<SongFileInfo> {
        return getSongFileInfoUseCase.invoke(GetSongFileInfoUseCase.Params(songId))
    }
