...
import com.breaktime.mustune.session_manager.impl.domain.SessionRepository
import dagger.Binds
...
interface SessionManagerModule {
    @Binds
    fun bindSettingsRepository(sessionRepository: SessionRepositoryImpl): SessionRepository
